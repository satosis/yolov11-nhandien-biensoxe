...
- **Lỗi `IndentationError` trong `core/config.py`**: chạy `python3 -m py_compile core/config.py`; nếu lỗi, `git pull` lại mã mới nhất hoặc khôi phục file `core/config.py` rồi chạy lại.
